 ...
 */
public class AtomicCounterMapProxy extends AsyncPrimitiveClient implements AsyncAtomicCounterMap<String> {
  private static final Serializer SERIALIZER = Serializer.using(KryoNamespace.builder()
      .register(KryoNamespaces.BASIC)
      .register(AtomicCounterMapOperations.NAMESPACE)
      .build());

  public AtomicCounterMapProxy(PrimitiveProxyClient proxy) {
    super(proxy);
  }

  @Override
  public CompletableFuture<Long> incrementAndGet(String key) {
    return client.invoke(INCREMENT_AND_GET, SERIALIZER::encode, new IncrementAndGet(key), SERIALIZER::decode);
  }

  @Override
  public CompletableFuture<Long> decrementAndGet(String key) {
    return client.invoke(DECREMENT_AND_GET, SERIALIZER::encode, new DecrementAndGet(key), SERIALIZER::decode);
  }

  @Override
  public CompletableFuture<Long> getAndIncrement(String key) {
    return client.invoke(GET_AND_INCREMENT, SERIALIZER::encode, new GetAndIncrement(key), SERIALIZER::decode);
  }

  @Override
  public CompletableFuture<Long> getAndDecrement(String key) {
    return client.invoke(GET_AND_DECREMENT, SERIALIZER::encode, new GetAndDecrement(key), SERIALIZER::decode);
  }

  @Override
  public CompletableFuture<Long> addAndGet(String key, long delta) {
    return client.invoke(ADD_AND_GET, SERIALIZER::encode, new AddAndGet(key, delta), SERIALIZER::decode);
  }

  @Override
  public CompletableFuture<Long> getAndAdd(String key, long delta) {
    return client.invoke(GET_AND_ADD, SERIALIZER::encode, new GetAndAdd(key, delta), SERIALIZER::decode);
  }
  ...
  public CompletableFuture<Long> put(String key, long newValue) {
    return client.invoke(PUT, SERIALIZER::encode, new Put(key, newValue), SERIALIZER::decode);
  }

  @Override
  public CompletableFuture<Long> putIfAbsent(String key, long newValue) {
    return client.invoke(PUT_IF_ABSENT, SERIALIZER::encode, new PutIfAbsent(key, newValue), SERIALIZER::decode);
  }
  ...
  public CompletableFuture<Long> remove(String key) {
    return client.invoke(REMOVE, SERIALIZER::encode, new Remove(key), SERIALIZER::decode);
  }

  @Override
  public CompletableFuture<Boolean> remove(String key, long value) {
    return client.invoke(REMOVE_VALUE, SERIALIZER::encode, new RemoveValue(key, value), SERIALIZER::decode);
  }
