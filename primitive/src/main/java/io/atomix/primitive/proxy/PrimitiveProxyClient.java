 ...
 * Raft client proxy.
 */
public interface PrimitiveProxyClient extends PrimitiveProxyExecutor {
   ...
   * ability to communicate with the cluster within the context of a {@link PrimitiveProxyClient}. In some cases, client
   * state changes may be indicative of a loss of guarantees. Users of the client should
   * {@link PrimitiveProxyClient#addStateChangeListener(Consumer) watch the state of the client} to determine when guarantees
   ...
   */
  CompletableFuture<PrimitiveProxyClient> connect();
